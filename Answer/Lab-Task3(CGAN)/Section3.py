...
netG = Generator3D(# [TODO] Implement your code).to(device)
netD = Discriminator3D(# [TODO] Implement your code).to(device)

criterion = nn.BCELoss()
# LR 조정 (옵션): lr=1e-4 또는 5e-5 시도 or your lr
optimizerD = optim.Adam(netD.parameters(), lr= # [TODO] Implement your code , betas=(0.5,0.999))
optimizerG = optim.Adam(netG.parameters(), lr= # [TODO] Implement your code , betas=(0.5,0.999))


num_epochs = # your epoch
...
for epoch in range(num_epochs):
    ...
    # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
    #                                                         #
    # Down Code should not be change but if you want it's ok  #
    #                                                         #
    # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
